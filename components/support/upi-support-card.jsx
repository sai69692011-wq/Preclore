...
export default function UpiSupportCard({ upiId, payeeName, note, title, subtitle }) {
  ...
  return (
    <div className="rounded-[28px] border-2 border-ink bg-white/80 p-6 shadow-[0_6px_0_0_rgba(44,43,42,1)]">
      <div className="text-xs font-black uppercase tracking-[0.3em] text-forest">UPI Support</div>
      ...
      <ol className="mt-4 list-decimal space-y-2 pl-5 text-sm text-ink/80">
        <li>Tap “Open UPI App” to continue in Google Pay, PhonePe, Paytm, or any UPI app.</li>
        <li>If that does not work, copy the UPI ID and paste it manually in your UPI app.</li>
